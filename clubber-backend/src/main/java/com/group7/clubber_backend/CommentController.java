...
public class CommentController {
    ...
    public PostResponse createComment(@RequestHeader("Authorization") String token,
        ...
        Review review = reviewManager.get(reviewId);
        if (review == null) {
    ...
    public GetResponse getCommentById(@PathVariable String reviewIdStr, @PathVariable String commentIdStr) {
        ...
        if (!comment.reviewId().toString().equals(reviewIdStr)){
    ...
    @GetMapping
    public GetAllByReviewResponse getCommentsByReview(@PathVariable String reviewIdStr) {
        ...
        List<Comment> comments = commentManager.search("reviewId:" + reviewIdStr);
    ...
    public PutResponse updateComment(@RequestHeader("Authorization") String token,
        ...
        if (!existingComment.reviewId().toString().equals(reviewIdStr)) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Comment does not belong to this review");
        }
    ...
    public DeleteResponse deleteComment(@RequestHeader("Authorization") String token,
        ...
        // Check if the comment belongs to the specified review
        if (!commentToDelete.reviewId().toString().equals(reviewIdStr)) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "Comment does not belong to this review");
        }
