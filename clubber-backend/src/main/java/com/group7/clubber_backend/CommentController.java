...
public class CommentController {
    ...
    public PostResponse createComment(
        ...
        try {
            reviewIdStr = new ReviewId(request.reviewId());
    ...
    @GetMapping
    public ListResponse<GetResponse> getCommentsByReview(
            @RequestParam("reviewId") String reviewIdStr
    ) {
    ...
    public ListResponse<GetResponse> getCommentsByUser(@PathVariable String userIdStr) {
